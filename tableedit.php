...
<title> Kapkoros Fertilizer Inventory Management System</title>
...
<h1>Kapkoros Fertilizer Inventory Management System </h1>
<ol id="toc">
...
<input type="number" name="<?php echo $qty_sold; ?>" min="0" oninput="validity.valid||(value='');" id="last_input_<?php echo $id; ?>">
</td>
<td>
